...
@interface HYWebVideoViewController ()<WKUIDelegate,WKNavigationDelegate>
...
//    [config setURLSchemeHandler:_webView forURLScheme:@"https://jx.playerjy.com/?url=https://www.iqiyi.com/v_xkt6z3z798.html?r_area=pcw_rec_like&r_source=56&bkt=tpfsfallrerank_07%3Btpfsfallrank_10%3Btp_fsfall_prerank_09&e=75e6e97690741877a9b2c7c2bcbf5032&stype=2&vfrm=pcw_home&vfrmblk=712211_cainizaizhui&vfrmrst=712211_cainizaizhui_image2"];
//    [config setURLSchemeHandler:_webView forURLScheme:@"https"];
//    [config setURLSchemeHandler:_webView forURLScheme:@"http"];
    ...
    [_webView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_offset(SCREEN_WIDTH * 0.5);
    }];
    
    NSURL * url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",headUrl,self.movieModel.playUrl]];
    if (url) {
